...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    ...
    <h1 class="display-4 font-weight-normal">機器予約システム</h1>
    <!-- <p class="lead font-weight-normal">And an even wittier subheading to boot. Jumpstart your marketing efforts with this example based on Apple's marketing pages.</p> -->
    <p class="lead font-weight-normal">九州大学のすべての研究者に開かれた共通機器の予約を行う事ができます</p>
    <!-- <a class="btn btn-outline-secondary" href="#">Coming soon</a> -->

    <!-- 仮ログイン画面へ移行_樋田 -->
    <a class="btn btn-outline-secondary" href="singup.php">ログオン</a>
  </div>
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
  <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
    <div class="my-3 py-3">
      ...
      <h2 class="display-5">他のヘッドライン</h2>
      <!-- <p class="lead">And an even wittier subheading.</p> -->
      <p class="lead">いい感じのサブヘッダー</p>
    </div>
